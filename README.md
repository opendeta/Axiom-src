# Axiom-src
# Axiom is a powerful Open-source mobile automation browser.
# Core Technical capabilities:
• *immortal Bot*: Working on multiple websites at once .
# Custom Bot interface (Native JS Bridge):
...
• *AppBot()* interface for Android System-level Clicks, Swipes & Scrolls with Bot.
 ...
 Start your Web Automation with Axiom!
